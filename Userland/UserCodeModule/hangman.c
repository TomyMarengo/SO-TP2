...
static char *words[] = {
    "aeropuerto", "murcielago", "zapatilla", "velocirraptor", "marengo", "mizrahi",
};
...
static void (*lives_actions[])(void) = {lose,           drawSteveRightLeg, drawSteveLeftLeg, drawSteveRightArm, drawSteveLeftArm,
                                        drawSteveTorso, drawSteveHead};
