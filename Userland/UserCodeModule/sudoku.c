...
static char easySudoku[SUDOKU_SIZE][SUDOKU_SIZE] = {
    {'0', '8', '3', '4', '7', '0', '0', '2', '6'}, {'2', '0', '7', '0', '3', '0', '8', '4', '0'},
    {'9', '4', '0', '8', '2', '6', '0', '3', '0'}, {'0', '0', '4', '7', '0', '8', '2', '0', '3'},
    {'0', '7', '8', '6', '4', '0', '0', '0', '0'}, {'6', '0', '0', '0', '0', '0', '0', '7', '0'},
    {'0', '0', '0', '0', '8', '7', '0', '5', '9'}, {'7', '2', '0', '5', '0', '0', '0', '8', '4'},
    {'8', '5', '6', '3', '0', '0', '0', '0', '2'}};

static char normalSudoku[SUDOKU_SIZE][SUDOKU_SIZE] = {
    {'0', '0', '8', '1', '0', '2', '5', '0', '0'}, {'0', '0', '0', '8', '0', '0', '3', '0', '0'},
    {'4', '0', '0', '5', '7', '0', '0', '0', '6'}, {'6', '0', '0', '4', '9', '0', '8', '0', '3'},
    {'0', '0', '0', '0', '0', '0', '9', '5', '2'}, {'0', '5', '0', '3', '2', '0', '0', '0', '7'},
    {'0', '8', '0', '0', '0', '7', '0', '0', '0'}, {'0', '4', '2', '0', '0', '0', '7', '0', '0'},
    {'0', '9', '3', '0', '0', '0', '0', '6', '8'}};

static char extremeSudoku[SUDOKU_SIZE][SUDOKU_SIZE] = {
    {'0', '0', '3', '0', '0', '2', '0', '0', '0'}, {'4', '0', '0', '0', '8', '0', '0', '3', '6'},
    {'0', '0', '8', '0', '0', '0', '1', '0', '0'}, {'0', '4', '0', '0', '6', '0', '0', '7', '3'},
    {'0', '0', '0', '9', '0', '0', '0', '0', '0'}, {'0', '0', '6', '0', '0', '0', '0', '0', '0'},
    {'0', '0', '4', '0', '7', '0', '0', '6', '8'}, {'6', '0', '0', '0', '0', '0', '0', '0', '0'},
    {'7', '0', '0', '0', '0', '0', '5', '9', '0'}};

static uint8_t
check(Cell board[SUDOKU_SIZE][SUDOKU_SIZE], int boardSize, uint8_t i, uint8_t j) {
...
static uint8_t
isValid(Cell board[SUDOKU_SIZE][SUDOKU_SIZE], int boardSize) {
    uint8_t checked = 1;
...
static void
updateCell(uint8_t row, uint8_t column, Color color) {
    sys_drawrect(VERTICALX + CHAR_WIDTH * (column * 2 + 1 + (int) column / 3),
                 HORIZONTALY + CHAR_HEIGHT * (row * 2 + 1 + (int) row / 3), CHAR_WIDTH, CHAR_HEIGHT, black);
    sys_writeat(&currentSudoku[row][column].value, 1, VERTICALX + CHAR_WIDTH * (column * 2 + 1 + (int) column / 3),
...
drawFrame() {
    ...
    for (int i = 0; i < 4; i++) {
        ...
        sys_drawline(HORIZONTALFROMX, HORIZONTALY + (CHAR_HEIGHT * i * 7), HORIZONTALTOX, HORIZONTALY + (CHAR_HEIGHT * i * 7),
                     blue);
    }
}

static void
drawNumbers(Cell sudoku[9][9]) {
...
sdk_init() {
    ...
    sys_writeat("Press 1 for easy, 2 for normal or 3 for extreme mode.", 53, width / 2 + CHAR_WIDTH, height - CHAR_HEIGHT * 3,
                gray);
