...
static void
list_push(list_t *list, list_t *entry) {
...
static void
flip_parent_is_split(size_t index) {
    index = PARENT(index);                         // Get the parent index
...
static size_t
bucket_for_request(size_t request) {
...
static int
lower_bucket_limit(size_t bucket) {
