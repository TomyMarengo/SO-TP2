 ...
 * or -1 if an error occurred.
 */
int addFdProcess(Pid pid, int fd, void *resource, FdReadHandler readHandler, FdWriteHandler writeHandler,
                 FdCloseHandler closeHandler, FdDupHandler dupHandler);
